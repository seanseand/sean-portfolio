...
export const AboutSection = () => {
  return (
    <Reveal
      as="section"
      id="about"
      className="max-w-[1180px] mx-auto px-[20px] sm:px-[24px] mg:px-[32px] lg:px-[40px] pt-[64px] mg:pt-[76px] lg:pt-[84px] pb-[32px] lg:pb-[40px]"
    >
      ...
      <div className="about-grid grid grid-cols-1 mg:grid-cols-[1.12fr_.88fr] lg:grid-cols-[1.3fr_1fr] gap-[24px] lg:gap-[30px] items-start">
        <div className="paper crumple px-[24px] mg:px-[30px] lg:px-[34px] pt-[26px] mg:pt-[30px] lg:pt-[34px] pb-[24px] lg:pb-[30px] shadow-[8px_9px_0_rgba(20,22,28,.12)] rotate-[-.5deg]">
          ...
          <div className="flex gap-[10px] flex-wrap mt-[24px] relative z-[1]">
            {["CREATIVITY", "STRATEGIC PLANNING", "ADAPTABILITY", "GROWTH MINDSET"].map(
              (tag) => (
                <span
                  key={tag}
                  className="bg-[#efe9d8] border-[1.5px] border-ink font-mono font-bold text-[clamp(10px,1vw,11px)] px-[11px] py-[6px]"
                >
                  {tag}
                </span>
              )
        ...
        <div className="flex flex-col gap-[18px]">
          <div className="paper px-[20px] mg:px-[22px] py-[20px] mg:py-[22px] shadow-[6px_7px_0_rgba(20,22,28,.12)] rotate-[1deg]">
            ...
            <div className="font-sans font-medium text-[clamp(12px,1.2vw,13px)] text-[#555]">
            ...
            <div className="font-sans font-medium text-[clamp(12px,1.2vw,13px)] text-[#555]">STEM Strand · 2021</div>
          </div>
          <div className="paper p-[20px] mg:p-[22px] shadow-[6px_7px_0_rgba(20,22,28,.12)] rotate-[-1.2deg]">
      ...
      <div className="certs-row flex gap-[16px] flex-wrap mt-[22px]">
        <div className="flex items-center gap-[12px] bg-ink text-[#efe9d8] px-[18px] mg:px-[20px] py-[13px] mg:py-[14px] rotate-[.6deg]">
